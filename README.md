...
This project is not perfect because it's my first big 3D game project, however it is still ongoing and not near finished.

## NEAR FUTURE CHANGES/ADDITIONS I WANT TO MAKE:
    ...
    - Create a UI
    - Chunk meshing
    - Player bodies (right now players are just a head)
